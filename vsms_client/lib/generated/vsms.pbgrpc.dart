...
class DiscoveryClient extends $grpc.Client {
  static final _$registerPeer =
      $grpc.ClientMethod<$0.RegisterPeerRequest, $0.RegisterPeerResponse>(
          '/vsms.Discovery/registerPeer',
          ($0.RegisterPeerRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $0.RegisterPeerResponse.fromBuffer(value));
  static final _$getPeer =
      $grpc.ClientMethod<$0.GetPeerRequest, $0.GetPeerResponse>(
          '/vsms.Discovery/GetPeer',
          ($0.GetPeerRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $0.GetPeerResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$0.RegisterPeerResponse> registerPeer(
      $0.RegisterPeerRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$registerPeer, request, options: options);
  }

  $grpc.ResponseFuture<$0.GetPeerResponse> getPeer($0.GetPeerRequest request,
      {$grpc.CallOptions? options}) {
...
abstract class DiscoveryServiceBase extends $grpc.Service {
  ...
  DiscoveryServiceBase() {
    $addMethod(
        $grpc.ServiceMethod<$0.RegisterPeerRequest, $0.RegisterPeerResponse>(
            'registerPeer',
            registerPeer_Pre,
            false,
            false,
            ($core.List<$core.int> value) =>
                $0.RegisterPeerRequest.fromBuffer(value),
  ...
  $async.Future<$0.RegisterPeerResponse> registerPeer_Pre(
      $grpc.ServiceCall $call,
      $async.Future<$0.RegisterPeerRequest> $request) async {
    return registerPeer($call, await $request);
  }

  $async.Future<$0.GetPeerResponse> getPeer_Pre($grpc.ServiceCall $call,
      $async.Future<$0.GetPeerRequest> $request) async {
    return getPeer($call, await $request);
  }

  $async.Future<$0.RegisterPeerResponse> registerPeer(
      $grpc.ServiceCall call, $0.RegisterPeerRequest request);
  $async.Future<$0.GetPeerResponse> getPeer(
      $grpc.ServiceCall call, $0.GetPeerRequest request);
}
